    ...
    <script src="<?= base_url() ?>/vendors/mapbox/mapbox-gl.js"></script>
    <script src="<?= base_url() ?>/vendors/mapbox/mapbox-gl-geocoder.js"></script>
...
<script src="<?= base_url('dashboard/plugins/sweetalert2.min.js') ?>"></script>
    <script src="<?= base_url() ?>/plugins/PageBuilder/Assets/js/elements.html"></script>
