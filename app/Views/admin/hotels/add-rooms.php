                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                $_hotel_name = $_GET['hotel_name'];
                                $_hotel_id = $_GET['hotel_id'];
                                ?>
                                <?= form_open_multipart(base_url('admin/add_rooms'), $attributes) ?>
                                    ...
                                    <div class="card card-body">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="room_name" class="form-control  gmz-validation  " id="gmz-field-post_title" value="">
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-4">
                                                ...
                                                <input type="number" name="price" class="form-control  gmz-validation  " id="gmz-field-post_title" value="">
                                            </div>
                                            <div class="col-md-4">
                                                <label class="none" for="gmz-field-post_title">Number of Room</label>
                                                <input type="number" name="total_rooms" class="form-control" accept="images/*">
                                            </div>
                                            <div class="col-md-4">
                                                <label class="none" for="gmz-field-post_title">Number of Beds</label>
                                                <input type="number" name="beds" class="form-control  gmz-validation  " id="gmz-field-post_title" value="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-4">
                                                ...
                                                <input type="number" name="adults" class="form-control  gmz-validation  " id="gmz-field-post_title" value="">
                                            </div>
                                            <div class="col-md-4">
                                                <label class="none" for="gmz-field-post_title">Number Of Children</label>
                                                <input type="number" name="childrens" class="form-control" accept="images/*">
                                            </div>
                                            <div class="col-md-4">
                                                <label class="none" for="gmz-field-post_title">Room Footage</label>
                                                <input type="number" name="footage" class="form-control  gmz-validation" id="gmz-field-post_title" value="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-12 mb-2">
                                                ...
                                                <input type="text" class="form-control" data-role="tagsinput" name="facilities" class="new-control-input" value="">
                                            </div>
                                        </div>
