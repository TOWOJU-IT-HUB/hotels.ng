                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    <div class="avater">
                                        <div class="form-group">
                                            <div class="img">
                                                <img class="rounded-circle" alt="profile image" id="blah" src="<?= base_url('uploads/profile_image/' . $user['profile_image']) ?>" width="150px" height="150px" data-holder-rendered="true">
                                            </div>
                                            <div class="action d-flex align-items-center mt-1">
                                                <a href="javascript:void(0)" onclick="$('#profile_image').trigger('click')" class="text-success mr-3" data-toggle="modal" data-target="#gmzMediaModal" data-url="/">Change image</a>
                                                <input type="file" hidden id="profile_image" name="profile_image">
                                            </div>
                                        </div>
                                    </div>
