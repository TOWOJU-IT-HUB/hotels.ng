                    ...
                    <div class="card card-pages mt-5">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <div class="col-12">
                                    <input class="form-control" type="hidden" name="email" required="" value="<?= $email ?>" id="email" placeholder="E-mail">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-12">
                                    <label for="password">New Password</label>
                                    <input class="form-control" minlength="8" type="password" name="password" required="" id="password" placeholder="Password">
                                </div>
                            </div>
                            <div class="form-group mt-4">
                                <div class="col-12">
                                    <label for="password">Confirm Password</label>
                                    <input class="form-control" type="password" name="passconf" required="" id="passconf" placeholder="Confirm Password">
                                </div>
                            </div>
