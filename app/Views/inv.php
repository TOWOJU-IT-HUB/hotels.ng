...
<div class="container">
    <p>
        <h4 style="text-align: center;">
            Your Payment on WEOTRIP has been received successfully, and we would get in touch with you if we need further information
        </h4>
    </p>
</div>
    ...
    <div class="invoice-box">
        <table cellpadding="0" cellspacing="0">
            ...
            <tr class="item"> <?php $_curr = $hotel['currencycode']; $newPriceGBP = getDueAmount($_curr, $amount) ?>
                ...
                <td>Amount Paid: <?= $hotel['currencycode'] . number_format($amount, 2) ?> (<?= PAYPAL_CURRENCY ?><span id='f_amount'><?= number_format($newPriceGBP, 2) ?></span>)</td>
            </tr>
            <tr class="item last">
                <td></td>
                <td>
        ...
        <div class="">
            <p>
                For more information kindly reach us via <a href="mailto:support@weotrip.com">support@weotrip.com</a>
            </p>
        </div>
    </div>
<?php 
