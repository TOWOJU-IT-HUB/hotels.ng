                                            ...
                                            <div class="p-2 mt-2">
                                                <ul class="list-unstyled latest-message-list mb-0">
                                                    <li class="message-list-item">
                                                        <a href="#">
                                                            <div class="media">
                                                                <img class="mr-3 thumb-md rounded-circle" src="<?= base_url() ?>/dashboard/images/users/user-2.jpg" alt="">
                                                    ...
                                                    <li class="message-list-item">
                                                        <a href="#">
                                                            <div class="media">
                                                                <img class="mr-3 thumb-md rounded-circle" src="<?= base_url() ?>/dashboard/images/users/user-3.jpg" alt="">
                                                                <div class="media-body">
                                                    ...
                                                    <li class="message-list-item">
                                                        <a href="#">
                                                            <div class="media">
                                                                <img class="mr-3 thumb-md rounded-circle" src="<?= base_url() ?>/dashboard/images/users/user-4.jpg" alt="">
                                                                <div class="media-body">
                                            ...
                                            <div class="p-2 mt-2">
                                                <ul class="list-unstyled latest-message-list mb-0">
                                                    <li class="message-list-item">
                                                        <a href="#">
                                                            <div class="media">
                                                                <img class="mr-3 thumb-md rounded-circle" src="<?= base_url() ?>/dashboard/images/users/user-5.jpg" alt="">
                                                                <div class="media-body">
                                                    ...
                                                    <li class="message-list-item">
                                                        <a href="#">
                                                            <div class="media">
                                                                <img class="mr-3 thumb-md rounded-circle" src="<?= base_url() ?>/dashboard/images/users/user-6.jpg" alt="">
                                                                <div class="media-body">
                                                    ...
                                                    <li class="message-list-item">
                                                        <a href="#">
                                                            <div class="media">
                                                                <img class="mr-3 thumb-md rounded-circle" src="<?= base_url() ?>/dashboard/images/users/user-7.jpg" alt="">
                                                                <div class="media-body">
                                        ...
                                        <table class="table table-hover mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <img src="<?= base_url() ?>/dashboard/images/users/user-1.jpg" alt="" class="thumb-md rounded-circle mr-2"> Philip Smead</td>
                                                    <td>April, 25</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="<?= base_url() ?>/dashboard/images/users/user-2.jpg" alt="" class="thumb-md rounded-circle mr-2"> Brent Shipley</td>
                                                    <td>April, 28</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="<?= base_url() ?>/dashboard/images/users/user-3.jpg" alt="" class="thumb-md rounded-circle mr-2">Kevin Ashley</td>
                                                    <td>June, 12</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="<?= base_url() ?>/dashboard/images/users/user-4.jpg" alt="" class="thumb-md rounded-circle mr-2">Martin Whitmer</td>
                                                    <td>June, 28</td>
                                                    <td><span class="badge badge-success">Medium</span></td>
                                                </tr>
                                                <!-- end 4 -->
                                        ...
                                        <table class="table table-hover mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <img src="<?= base_url() ?>/dashboard/images/users/user-5.jpg" alt="" class="thumb-md rounded-circle mr-2"> Enrique Peters</td>
                                                    <td>July, 15</td>
                                                    <td><span class="badge badge-danger">Low</span></td>
                                                </tr>
                                                <!-- end 5 -->
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="<?= base_url() ?>/dashboard/images/users/user-6.jpg" alt="" class="thumb-md rounded-circle mr-2"> Richard Schnell</td>
                                                    <td>July, 30</td>
                                                    <td><span class="badge badge-primary">High</span></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="<?= base_url() ?>/dashboard/images/users/user-7.jpg" alt="" class="thumb-md rounded-circle mr-2">Dennis Jackson</td>
                                                    <td>August, 08</td>
                                                    <td><span class="badge badge-success">Medium</span></td>
                                                </tr>
                                                <!-- end 7 -->
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <img src="<?= base_url() ?>/dashboard/images/users/user-8.jpg" alt="" class="thumb-md rounded-circle mr-2">Carlos Rodrigues</td>
                                                    <td>August, 23</td>
                                                    <td><span class="badge badge-danger">Low</span></td>
                                                </tr>
