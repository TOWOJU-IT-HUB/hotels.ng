                            ...
                            <div class="search-form__basic">
                                ...
                                <div class="search-form__from date-group">
                                    ...
                                    <span class="check-in-render" data-date-format="DD/MM/YYYY">
                                        <?php if(isset($_GET['checkIn'])){ echo $_GET['checkIn']; } else { echo "Check In"; } ?>
                                    </span>
                                </div>
                                <div class="search-form__to date-group">
                                    <i class="fal fa-calendar-alt"></i>
                                    <span class="check-out-render" data-date-format="DD/MM/YYYY">
                                        <?php if(isset($_GET['checkOut'])){ echo $_GET['checkOut']; } else { echo "Check Out"; } ?>
                                    </span>
                                </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <?php 
                                                if(!empty($_GET['price_range'])){
                                                    $pricy = explode(";", $_GET['price_range']);
                                                    $min_price = $pricy[0];
                                                    $max_price = $pricy[1];
                                                    $this->hotels->where(" `min_total_price` >= $min_price AND `min_total_price` <= $max_price");
                                                }
                                            ?>
                                            <input type="text" class="price-range-slider" name="price_range" value="" data-min="0.00" data-max="10800.00" data-form="<?php if($_GET['price_range']){ echo $min_price; } else { echo  '250.00'; } ?>" data-to="8000.00" data-prefix="" data-postfix="" />
