            ...
            <div class="popup-content">
                ...
                <div class="form">
                    ...
                    <div id="phone_number-field" class="field-wrapper input">
                        ...
                        <input name="tel" type="number" value="" required class="form-control gmz-validation" data-validation="required" placeholder="Phone Number">
                    </div>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div id="password-field" class="field-wrapper input mb-2">
                                ...
                                <i class="fal fa-lock"></i>
                                <input id="rpassword" name="password" type="password" minlength="8" class="form-control gmz-validation" data-validation="required" placeholder="<?= lang('text.password') ?>">
                                <div class="view-password">
                                    <i class="fal fa-eye view"></i>
                                    <i class="fal fa-eye-slash not-view"></i>
                                </div>
                        ...
                        <div class="col-6">
                            <div id="password-field" class="field-wrapper input mb-2">
                                ...
                                <i class="fal fa-lock"></i>
                                <input id="rpassword" name="confpass" type="password" minlength="8" class="form-control gmz-validation" data-validation="required" placeholder="Confirm Password">
                                <div class="view-password">
                                    <i class="fal fa-eye view"></i>
                                    <i class="fal fa-eye-slash not-view"></i>
                                </div>
            ...
            <ul id="menu-primary-1" class="main-menu">
                ...
                <li class="menu-item-has-children">
                    ...
                    <ul role="menu" class="sub-menu">
                        ...
                        <li class="menu-item-has-children">
                            <a href="<?= base_url() ?>/search?room_type=Motels">Motels</a>
                        </li>
                        <li class="menu-item-has-children">
                            <a href="<?= base_url() ?>/search?room_type=Hostel">Hostel</a>
                        </li>
                        <li class="menu-item-has-children">
                            <a href="<?= base_url() ?>/search?room_type=Resorts">Resorts</a>
                        </li>
                        <li class="menu-item-has-children">
                            <a href="<?= base_url() ?>/search?room_type=Villa">Villa</a>
                        </li>
